...
import { Plus, Maximize, Droplet, Wind, Target } from "lucide-react";

export function BackpackFeatureSection() {
  return (
          ...
          <div className="relative z-10 w-full max-w-md lg:w-1/3">
            <div className="flex gap-4 rounded-[20px] bg-white/80 p-4 shadow-sm backdrop-blur-md">
              ...
              <div className="flex flex-col justify-center">
                <h3 className="font-semibold text-neutral-900">Versatile capacity</h3>
                <p className="mt-2 text-[11px] leading-tight text-neutral-500">
                  Available in 25L and 38L options, making<br/>
                  it perfect for anything from a day hike to<br/>
                  extended adventures.
                </p>
              </div>
            </div>
            ...
            <div className="absolute -bottom-32 left-0 hidden lg:block">
              <div className="flex flex-col items-start">
                <span className="font-serif text-sm font-semibold uppercase italic text-neutral-700 ml-2">NEED MORE SPACE?</span>
                {/* Hand-drawn arrow SVG */}
                <svg className="my-2 h-8 w-8 ml-6 stroke-neutral-700" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex gap-3 text-2xl font-medium">
                  ...
                  <span className="text-neutral-400">38L</span>
                </div>
              </div>
            </div>
          </div>
